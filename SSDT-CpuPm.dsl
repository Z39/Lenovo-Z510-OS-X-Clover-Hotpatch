DefinitionBlock ("", "SSDT", 1, "z510 ", "CpuPm", 0x00015600)
{
    ...
    Scope (\_PR.CPU0)
    {
        ...
        {
            Store ("ssdtPRGen version....: 15.6 / Mac OS X 10.13.2 (17C89)", Debug)
            Store ("target processor.....: i7-4702MQ", Debug)
            Store ("running processor....: Intel(R) Core(TM) i7-4702MQ CPU @ 2.20GHz", Debug)
